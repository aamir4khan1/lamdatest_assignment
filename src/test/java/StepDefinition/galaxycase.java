...
public class galaxycase {
	...
	@And("user searches for samasung galaxy")
	public void user_searches_for_samasung_galaxy() throws InterruptedException{
		Thread.sleep(2000);
	...
	public void user_selects_an_device() throws InterruptedException {
		Thread.sleep(2000);
	...
	public void user_adds_the_device_in_cart() throws InterruptedException {
		Thread.sleep(2000);
