...
//	}
	...
	public void user_select_city_selector_on_plp() throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement similarCar = driver.findElement(By.xpath(cr.valueOnTheKey("similarCar")));
		Assert.assertEquals(true, similarCar.isDisplayed());
		
		/*
		 * }
		 * 
		 * @And("user select bangalore city") public void user_select_bangalore_city()
		 * throws InterruptedException { Thread.sleep(2000); prm.click(driver,
		 * cr.valueOnTheKey("plp_citySelectBangalore"), "xpath"); Thread.sleep(4000);
		 */
	/*}
