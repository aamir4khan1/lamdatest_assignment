...
import io.cucumber.java.en.When;
 ...
 class carfinderbanner {
	...
	public void clicks_on_the_car_finder_banner_on_homepage() throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement question_screen = driver.findElement(By.xpath(cr.valueOnTheKey("question_screen"))); // Logout assertion//
	...
	public void user_selects_fuel_type_preference() throws InterruptedException {
		...
		Thread.sleep(2000);
		prm.click(driver, cr.valueOnTheKey("Carfinder_fueltype"),"xpath");
