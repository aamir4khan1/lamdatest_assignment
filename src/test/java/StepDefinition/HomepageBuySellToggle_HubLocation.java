...
public class HomepageBuySellToggle_HubLocation {
	...
	// Buy_Sell_Toggle__Test_Case//
		...
		public void click_on_sell_toggle() throws InterruptedException {
			...
			Thread.sleep(4000);
			WebElement sellcontentSection = driver.findElement(By.xpath(cr.valueOnTheKey("homepage_sellSectionContentSection")));
			Assert.assertEquals(true, sellcontentSection.isDisplayed());
			WebElement sellToggleImageSection = driver.findElement(By.xpath(cr.valueOnTheKey("homepage_sellToggleImageSection")));
			Assert.assertEquals(true, sellToggleImageSection.isDisplayed());
			WebElement sellToggleBenefitsSection = driver.findElement(By.xpath(cr.valueOnTheKey("homepage_sellToggleBenefitsSection")));
			Assert.assertEquals(true, sellToggleBenefitsSection.isDisplayed());
			WebElement sellToggleBrandsContainer = driver.findElement(By.xpath(cr.valueOnTheKey("homepage_sellToggleBrandsContainer")));
